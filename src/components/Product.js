...
<div className="row row-cols-1 row-cols-md-4 g-4 mt-5 mb-3">
  ...
  <div className="col">
    <div className="card shadow-lg">
      <img src="images/withers.jfif" className="card-img-top" alt="..."style={{height:'200px'}}/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
  ...
  <div className="col">
    <div className="card shadow-lg">
      <img src="images/voilence.jpg" className="card-img-top" alt="..."style={{height:'200px'}}/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
  ...
  <div className="col">
    <div className="card shadow-lg">
      <img src="images/blade.jpg" className="card-img-top" alt="..."style={{height:'200px'}}/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
  ...
  <div className="col">
    <div className="card shadow-lg">
      <img src="images/mask.jpg" className="card-img-top" alt="..."style={{height:'200px'}}/>
      <div className="card-body">
        <h5 className="card-title">Card title</h5>
